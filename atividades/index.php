...
<body>
    ...
    <tbody>
      ...
      foreach ($atividades as $atividade) {
        ...
        echo "<td>
                    ...
                    <a href='excluir.php?id={$atividade->getId()}'>Excluir</a>
                </td>";
        echo "</tr>";
      }
      ?>
  ...
  <a href='incluir.php'>Criar Atividades</a><br>
  <a href='realizadas.php'>Atividades Realizadas</a><br>
  <a href='pendentes.php'>Atividades Pendentes</a><br>
